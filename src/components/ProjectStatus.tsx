 ...
 * ProjectStatus.jsx
 *
 * A transparent, honest component that communicates:
 ...
 *
 * Designed with a warm educational palette (blue, gold, green),
 * responsive grid layout, subtle animations, and professional styling.
 *
 * Props:
 ...
 *
 * Built with ❤️ by a Grade 11 Student
 */
...
const PROBLEMS = [
  {
    ...
    description:
      'Students have textbooks from Grades 9–12 but don&rsquo;t know how to connect topics across years. The Ethiopian national exam covers ALL four years — 30% from Grades 9–10 and 70% from Grades 11–12.',
  ...
  },
  {
    ...
    description:
      `Students don&rsquo;t track daily study habits, mock exam scores, or mistakes. Victory Hub provides daily missions, streak tracking, score logging, and mistake logging to build accountability.`,
  ...
  },
  {
    ...
    description:
      `Students don&rsquo;t use structured study sessions. Victory Hub includes a Pyramid Timer with 50/30/20 minute presets that mirror the recommended study time distribution.`,
  ...
  },
  {
    ...
    description:
      `Students can&rsquo;t easily see how topics connect across grades. Victory Hub has a Book &amp; Chapter Link Tracker where users manually add textbooks and create cross-grade connections.`,
...
const LIMITATIONS = [
  {
    ...
    description:
      `All data is stored in the browser&rsquo;s localStorage. Clearing cache or using a different device erases all progress.`,
    severity: 'high',
  },
  {
    icon: UserX,
  ...
  },
  {
    ...
    description:
      `Statistics like &ldquo;9 Subjects, 150+ Lessons&rdquo; on the home page are placeholders and do not update dynamically based on real data.`,
    severity: 'low',
  },
  {
    icon: Keyboard,
...
const WORKING_FEATURES = [
  {
    ...
    description: 'Add, complete, and delete daily study tasks',
  },
  {
    icon: Timer,
    title: 'Pyramid Timer',
    description: '50 / 30 / 20 minute presets with start, pause, and reset',
  },
  {
    icon: Link2,
    title: 'Book & Chapter Link Tracker',
    description: 'Manually add textbooks and create cross-grade links',
  },
  {
    icon: Flame,
    title: 'Streak Counter',
    description: 'Tracks consecutive study days to build consistency',
  },
  {
    icon: BarChart3,
    title: 'Score Tracker',
    description: 'Log and review mock exam scores over time',
  },
  {
    icon: AlertTriangle,
    title: 'Mistake Log',
    description: 'Record mistakes and review them before the exam',
  },
  {
    icon: ShieldCheck,
    title: 'Local Data Persistence',
    description: 'All data saves automatically in browser localStorage',
  },
];
...
const FUTURE_FEATURES = [
  {
    ...
    description: 'Login system with data that follows you across devices',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: LineChart,
    title: 'Interactive Progress Charts',
    description: 'Dynamic analytics that update with real study data',
    color: 'from-emerald-500 to-teal-500',
  },
  {
    icon: Sparkles,
    title: 'AI-Powered Chapter Links',
    description: 'Automatic suggestions for connecting topics across grades',
    color: 'from-violet-500 to-purple-500',
  },
  {
    icon: Smartphone,
    title: 'Mobile App Version',
    description: 'Native Android/iOS app for studying on the go',
    color: 'from-amber-500 to-orange-500',
  },
  {
    icon: Users,
    title: 'Shared Library',
    description: 'Collaborate and share chapter links with classmates',
    color: 'from-rose-500 to-pink-500',
  },
  {
    icon: Download,
    title: 'Export / Import Backup',
    description: 'Backup your data and restore it on any device',
    color: 'from-sky-500 to-blue-500',
  },
  {
    icon: PenTool,
    title: 'Automated Quiz Generator',
    description: 'Generate practice quizzes from your recorded mistakes',
...
function SeverityBadge({ severity }: { severity: string }) {
  const config = {
    high: { label: 'High Impact', className: 'bg-red-500/15 text-red-600 dark:text-red-400 border-red-500/20' },
    medium: { label: 'Medium Impact', className: 'bg-amber-500/15 text-amber-600 dark:text-amber-400 border-amber-500/20' },
    low: { label: 'Low Impact', className: 'bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-emerald-500/20' },
  };
...
/* ==================================================================
   SUB-COMPONENT: LIMITATIONS SECTION
   ================================================================== */
        ...
        <div className="mt-4 rounded-xl border border-amber-500/20 bg-amber-500/5 p-4">
          <div className="flex gap-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              limitations so you know exactly what you&rsquo;re getting. No false promises.
            </p>
          </div>
        </div>
      </motion.div>
...
/* ==================================================================
   SUB-COMPONENT: WHAT WORKS SECTION
   ================================================================== */
...
/* ==================================================================
   SUB-COMPONENT: FUTURE VISION SECTION
   ================================================================== */
      ...
      <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl p-8 text-center">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground max-w-lg mx-auto leading-relaxed">
            ...
            preparing for the Ethiopian national exam. It&rsquo;s not perfect — but
            it&rsquo;s honest, it&rsquo;s useful, and it&rsquo;s constantly improving.
          </p>
        </div>
...
/* ==================================================================
   MAIN COMPONENT: ProjectStatus
   ================================================================== */

/**
 * ProjectStatus — A transparent status component for Victory Hub.
 *
 * @param {Object} props
 * @param {boolean} props.showLimitations — Show/hide the Limitations section (default: true)
 * @param {boolean} props.showVision     — Show/hide the Future Vision section (default: true)
 * @param {string}  props.className      — Additional CSS classes on the root wrapper
 */
export default function ProjectStatus({
  ...
  return (
    <div className={`space-y-14 ${className}`}>
      ...
      {/* ---- What Works Section (always visible) ---- */}
      <WorksSection />

      {/* ---- Limitations Section (optional) ---- */}
      {showLimitations && <LimitationsSection />}

      {/* ---- Future Vision Section (optional) ---- */}
